 ...
 * 
 * Operates just as standard cached object, and contains an array list of
 * objects.
 * 
 * <b>Must</b> be initialized with the class of the objects stored, as this is
 * used in parcelling/unparcelling.
 * 
 * In order to ensure thread-safe use of list (such as iteration), use the
 * {@link #getList()} method, creating a copy of the list in its current state.
 * 
...
public class CachedList<CO extends CachedModel> extends CachedModel {
	...
	/**
	 * Simple parameter-less constructor. <b>Must</b> also have parameter-less
	 * constructor in subclasses in order for parceling to work.
	 * 
	 * <b>Do not use this constructor when creating a list, use one setting
	 * class instead.</b>
	 */
	public CachedList() {
	...
	/**
	 * Constructor setting variables from parcel. Same as using a blank
	 * constructor and calling readFromParcel.
	 * 
	 * @param source
	...
	/**
	 * Constructor initializing class of objects stored as well as initial
	 * length of list.
	 * 
	 * @param clazz
	 *            Required for parcelling and unparcelling of list
	...
	/**
	 * Constructor initializing class of objects stored as well as id used in
	 * key generation.
	 * 
	 * @param clazz
	 *            Required for parcelling and unparcelling of list
	...
	/**
	 * Synchronized method to get a copy of the list in its current state. This
	 * should be used when iterating over the list in order to avoid
	...
	/**
	 * @see com.idreamsky.core.cache.github.droidfu.cachefu.CachedModel#createKey(java.lang.String)
	 */
	@Override
	...
	public boolean reload(ModelCache modelCache) {
		...
		// Then reload each item in list. Sometimes a
	...
	/**
	 * @see com.idreamsky.core.cache.github.droidfu.cachefu.CachedModel#reloadFromCachedModel(com.idreamsky.core.cache.github.droidfu.cachefu.ModelCache,
	 *      com.idreamsky.core.cache.github.droidfu.cachefu.CachedModel)
	 */
	@Override
	public synchronized boolean reloadFromCachedModel(ModelCache modelCache,
	...
	/**
	 * @see com.idreamsky.core.cache.github.droidfu.cachefu.CachedModel#readFromParcel(android.os.Parcel)
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Override
	public void readFromParcel(Parcel source) throws IOException {
		super.readFromParcel(source);
		// Read class from parcel, then load class and use creator to generate
		// new object from data
		String className = source.readString();
		try {
			clazz = (Class<? extends CachedModel>) Class.forName(className);
			list = source.createTypedArrayList((Creator) clazz.getField(
					"CREATOR").get(this));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	/**
	 * @see com.idreamsky.core.cache.github.droidfu.cachefu.CachedModel#writeToParcel(android.os.Parcel,
	 *      int)
	 */
	@Override
	public void writeToParcel(Parcel dest, int flags) {
		super.writeToParcel(dest, flags);
		// Write class name to parcel before object, so can be loaded correctly
		// back in
