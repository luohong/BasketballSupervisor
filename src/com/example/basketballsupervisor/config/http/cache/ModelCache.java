...
/**
 * Allows caching Model objects using the features provided by
 * {@link AbstractCache}. The key into the cache will be based around the cached
 * object's key, and the object will be able to save and reload itself from the
 * cache.
 * 
...
public class ModelCache extends AbstractCache<String, CachedModel> {
	...
	/**
	 * Creates an {@link AbstractCache} with params provided and name
	 * 'ModelCache'.
	 * 
	 * @see com.github.droidfu.cachefu.AbstractCache#AbstractCache(java.lang.String,
	 *      int, long, int)
	 */
	public ModelCache(int initialCapacity, long expirationInMinutes,
			int maxConcurrentThreads) {
		super("ModelCache", initialCapacity, expirationInMinutes,
				maxConcurrentThreads);
	}

	// Counter for all saves to cache. Used to determine if newer object in
	// cache
	private long transactionCount = Long.MIN_VALUE + 1;

	/**
	 * @see com.github.droidfu.cachefu.AbstractCache#put(java.lang.Object,
	 *      java.lang.Object)
	 */
	@Override
	public synchronized CachedModel put(String key, CachedModel value) {
		// Set transaction id for checking validity against other values with
		// same key
	...
	public String getCacheDirectory() {
		return Library.Instance().getModelCache();
	}
